...
class GoldCache(implicit val p: fconfig.Parameters) extends Module with CacheParams {
...
class CacheTester(cache: => Cache)(implicit val p: fconfig.Parameters) extends BasicTester with CacheParams {
  /* Target Design */
